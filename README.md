...
You can simply download and import the **MultiTransform.unitypackage** into your Unity Project manually. (TODO: Add package release branch)

Or you can go to the MultiTransform Asset Store page and download it from there. (TODO: Add AssetStore page)
...
```
$ git submodule add https://github.com/DuskModules/MultiTransform Assets/DuskModules/1-UtilityModules/MultiTransform
```
...
https://sites.google.com/dusklightstudios.com/duskmodules/utility-modules/multitransform
